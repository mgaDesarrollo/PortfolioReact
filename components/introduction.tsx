            ...
            <div className="z-20 grid items-center h-full p-6 py-20 md:py-0 md:grid-cols-2">
                ...
                <div className="flex flex-col justify-center max-w-md">
                    ...
                    <p className="mx-auto mb-2 text-xl md:text-xl md:mx-0 md:mb-8">
                        ...
                        Como desarrollador frontend, me apasiona crear experiencias de usuario excepcionales mediante React. Creador de interfaces dinámicas y escalables, utilizando componentes reutilizables y código limpio para garantizar un desarrollo eficiente y mantenible.
                    </p>
